...
namespace SmoothBoardStylersApp.Controllers
{
    ...
    public class SurfboardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naam,Beschrijving,MateriaalId,Prijs,FotoUrl")] Surfboard surfboard, IFormFile fotoFile)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["MateriaalId"] = new SelectList(_context.Materialen, "Id", "Id", surfboard.MateriaalId);
            return View(surfboard);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naam,Beschrijving,MateriaalId,Prijs,FotoUrl,Leverbaar")] Surfboard surfboard, IFormFile fotoFile)
        {
            if (id != surfboard.Id)
            {
                return NotFound();
